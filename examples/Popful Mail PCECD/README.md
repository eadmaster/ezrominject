...
5. Download and select the corresponding xdelta patch:
   - [`PopfulMail (Japan) (Track 02).bin.xdelta`](https://git.new/popful-mail-eng-xdelta) (Jap dub)
   - [`02 Magical Fantasy Adventure - Popful Mail (J).iso.xdelta`](https://git.new/popful-mail-eng-dub-xdelta) (Eng dub)
...
7. Download and use the corresponding cue sheet in this folder to play the game (Right-click->Save link as...):
   ...
   - [`PopfulMail (English)(dub).cue`](https://raw.githubusercontent.com/eadmaster/ezrominject/refs/heads/main/examples/Popful%20Mail%20PCECD/PopfulMail%20(English)(dub).cue) (Eng dub)
