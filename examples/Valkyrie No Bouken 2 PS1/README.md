# Valkyrie No Bouken PS1 English Translation
...
![shot](demo1.png)  ![shot](demo3.png)  ![shot](demo4.png)  
...
5. Click "Apply patch" and save in the same folder without changing the filename: `Namco Anthology 2 (Japan) (patched).bin`
