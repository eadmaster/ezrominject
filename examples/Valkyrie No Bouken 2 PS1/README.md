...
4. Download the [latest xdelta patch in this folder](Namco%20Anthology%202%20(Japan)%20(patched).bin.xdelta?raw=true), and use it as the Patch file
...
7. Download and use the [cue sheet in this folder](Namco%20Anthology%202%20(English).cue?raw=true) to play the game (Right-click->Save link as...).
