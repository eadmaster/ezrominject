...
2. Obtain a disc dump matching [these hashes](http://redump.org/disc/52121/)
3. Download the latest xdelta patch in this folder
4. Visit [Rom Patcher JS](https://www.marcrobledo.com/RomPatcher.js/)
5. Select `Basted (Japan) (Track 02).bin` as ROM file
6. Select `.xdelta` as Patch file
7. Click "Apply patch" and save in the same folder without changing the filename: `"Basted (Japan) (Track 02) (patched).bin`
