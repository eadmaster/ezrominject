...
4. Download the [latest xdelta patch in this folder](In%20Magical%20Adventure%20-%20Fray%20CD%20-%20Xak%20Gaiden%20(Japan)%20(Track%2002).bin.xdelta?raw=true), and use it as the Patch file.
...
6. Download and use the cue sheet in this folder to play the game (Right-click->Save link as...):
   - [Japanese-dubbed version](In%20Magical%20Adventure%20-%20Fray%20CD%20-%20Xak%20Gaiden%20(English).cue?raw=true)
   - [English-dubbed version](In%20Magical%20Adventure%20-%20Fray%20CD%20-%20Xak%20Gaiden%20(English)(dub).cue?raw=true). This also needs [ALL the wave files in this shared folder](https://www.mediafire.com/folder/grzvl6cd2g6rp/In_Magical_Adventure_-_Fray_CD_-_Xak_Gaiden_(English)(dub))


# Credits/Contributors/Special thanks

 - [eadmaster](https://github.com/eadmaster): translation, hacking, playtesting.
 - [Daniel-McLarty](https://github.com/Daniel-McLarty/): [original dubbing pipeline](https://github.com/Daniel-McLarty/Python-Autodub).
